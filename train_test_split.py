...
# plt.scatter(df1["sepal length (cm)"], df0["sepal width (cm)"], color="black", marker="+")
...
# plt.xlabel("patel width (cm)")
# plt.scatter(df0["patel length (cm)"],df0["patel width (cm)"],color="green",marker="+")
# plt.scatter(df1["patel length (cm)"],df0["patel width (cm)"],color="green",marker=".")
